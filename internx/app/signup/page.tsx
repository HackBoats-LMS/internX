  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] px-4">
      <div className="w-full max-w-sm p-8 bg-[#111] rounded-2xl shadow-2xl border border-white/5">
        <h2 className="text-2xl font-bold text-center mb-6 text-white tracking-tight">Create an Account</h2>
        
        <form className="flex flex-col gap-4">
          <div className="flex flex-col gap-1.5">
            <label className="text-xs font-semibold uppercase tracking-wider text-gray-400 ml-1" htmlFor="name">Full Name</label>
            <input
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-xs font-semibold uppercase tracking-wider text-gray-400 ml-1" htmlFor="password">Password</label>
            <input
              className="px-4 py-2.5 bg-black border border-white/10 text-white placeholder-gray-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#ff1a1a] focus:border-transparent transition-all"
              id="password"
              name="password"
