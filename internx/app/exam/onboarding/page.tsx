...
import { Checkbox } from '@/components/exam/ui/checkbox'
...
import { upsertProfile, getColleges, getDepartments, checkExamStatus } from '@/app/exam/actions'
...
export default function OnboardingPage() {
    ...
    const startExam = () => {
        ...
        if (element.requestFullscreen) {
            element.requestFullscreen().then(() => router.push('/exam/quiz')).catch(() => router.push('/exam/quiz'))
        } else router.push('/exam/quiz')
    }
